...
@section('title','Create Related Ticket')
            ...
            <h1 class="incomplete__header-primary">Create Related Ticket</h1>
                <div class="incomplete__flex">
                    <div class="incomplete__left">
                        ...
                        <label class="form-addTicketDetails__ticket">Related to Ticket #: <input name="rt_id" type="text" value="{{$ticket->id}}" readonly class="form-addTicketDetails__ticket-value"></label>  
