                    ...
                    <aside class="side">
                        ...
                        <div class="side__content">
                            <dl class="side__dl" >
                                ...
                                <dd class="side__dd {{Route::currentRouteName() == 'datacorrections.system' ? 'selecteddc--active' : ''}}"><a href="{{ route('datacorrections.system') }}" style="text-decoration:none;color:black;">System Data Correction ({{ $sdcCount }})</a></dd>
